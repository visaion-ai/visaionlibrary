"""
This config is for the RTMDet-ins_l model.
...
backbone_widen_factor = 1.0  # set fixed
backbone_deepen_factor = 1.0  # set fixed
neck_in_channels = [256, 512, 1024]  # set fixed
neck_out_channels = 256   # set fixed
bbox_head_feat_channels = 256  # set fixed
bbox_head_in_channels = 256  # set fixed
neck_num_csp_blocks = 3  # set fixed
