"""
This config is for the RTMDet-ins_s model.
...
backbone_widen_factor = 0.5  # set fixed
backbone_deepen_factor = 0.33  # set fixed
neck_in_channels = [128, 256, 512]  # set fixed
neck_out_channels = 128   # set fixed
bbox_head_feat_channels = 128  # set fixed
bbox_head_in_channels = 128  # set fixed
