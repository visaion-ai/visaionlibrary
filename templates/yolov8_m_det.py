...
deepen_factor = 0.67  # set fixed
widen_factor = 0.75  # set fixed
backbone_last_stage_out_channels = 768  # set fixed
neck_in_channels = [256, 512, 768]  # set fixed
neck_out_channels = [256, 512, 768] # set fixed
bbox_head_in_channels = [256, 512, 768]  # set fixed
