...
deepen_factor = 1.0  # set fixed
widen_factor = 1.0  # set fixed
backbone_last_stage_out_channels = 512  # set fixed
neck_in_channels = [256, 512, 512]  # set fixed
neck_out_channels = [256, 512, 512] # set fixed
bbox_head_in_channels = [256, 512, 512]  # set fixed
