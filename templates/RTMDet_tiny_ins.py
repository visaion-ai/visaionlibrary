...
backbone_widen_factor = 0.375  # set fixed
backbone_deepen_factor = 0.167  # set fixed
neck_in_channels = [96, 192, 384]  # set fixed
neck_out_channels = 96   # set fixed
bbox_head_feat_channels = 96  # set fixed
bbox_head_in_channels = 96  # set fixed
