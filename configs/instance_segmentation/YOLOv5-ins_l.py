"""
This config is for the YOLOv5-ins_l model.
...
load_from = '/data/projects/visaionlib/pretrained_weights/yolov5_ins_l-v61_syncbn_fast_8xb16-300e_coco_instance_20230508_104049-daa09f70.pth'
...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_bbox=dict(
            ...
            type='IoULoss'),
        loss_cls=dict(
            loss_weight=0.3*(num_classes/80),
            reduction='mean',
        ...
        loss_obj=dict(
            loss_weight=0.7*((crop_size/640)**2),
            reduction='mean',
            type='mmdet.CrossEntropyLoss',
            use_sigmoid=True),
        mask_overlap=True,
...
data_root = '/data/datasets/balloon/balloon-train1'
color_type = "color"  # auto config
val_data_root = "/data/datasets/balloon/balloon-val1"  # auto config
test_data_root = "/data/datasets/balloon/balloon-val1"  # auto config
