"""
This config is for the HYHUNet-RegNetX-400mf-8X model.
...
# training config ----------------------------------------------------------------------------------------
_work_dir = (
    "/root/projects/visaionlib/workspace/debug/HYHUNet-RegNetX-400mf-8X"  # auto config
)
