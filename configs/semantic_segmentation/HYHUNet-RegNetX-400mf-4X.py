"""
This config is for the HYHUNet-RegNetX-400mf-4X model.
...
checkpoint = "/root/projects/visaionlib/pretrained_weights/regnetx-400mf_8xb128_in1k_20211213-89bfc226.pth"  # auto config
...
model = dict(
    ...
    decode_head=dict(
        ...
        input_channel_list=[32, 64, 160, 384],
        last_scale_factor=4,
        conv_cfg=None,
        norm_cfg=dict(type="SyncBN", requires_grad=True),
...
# training config ----------------------------------------------------------------------------------------
_work_dir = (
    "/root/projects/visaionlib/workspace/debug/HYHUNet-RegNetX-400mf-4X"  # auto config
)
