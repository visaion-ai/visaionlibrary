...
class BaseDecodeHead(BaseModule, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        assert num_classes >= 2, 'at least 2 classes have to be set (background class is added by default)'
        ...
        # this variable controls the sigmoid activation before loss
        # it affects prediction and inference
        # it should be compatible with the loss
